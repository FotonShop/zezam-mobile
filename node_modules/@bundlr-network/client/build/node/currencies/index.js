...
function getCurrency(currency, wallet, providerUrl, contractAddress) {
    switch (currency) {
        ...
        case "matic":
            return new ethereum_1.default({ name: "matic", ticker: "MATIC", providerUrl: providerUrl !== null && providerUrl !== void 0 ? providerUrl : "https://morning-hidden-forest.matic.quiknode.pro/2864d4b10b348d1e7799cea5cbab433418741098", wallet });
        case "bnb":
        ...
        case "solana":
            return new solana_1.default({ name: "solana", ticker: "SOL", providerUrl: providerUrl !== null && providerUrl !== void 0 ? providerUrl : "https://proud-autumn-frog.solana-mainnet.quiknode.pro/e7db7fce0970bc5dad50d1a5f181f37bbea536c7/", wallet });
        case "avalanche":
